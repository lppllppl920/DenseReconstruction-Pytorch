...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(
        description='Dense feature matching',
    ...
    parser.add_argument('--precompute_root', type=str, required=True, help='path to the precompute data')
    ...
    sift = cv2.xfeatures2d.SIFT_create(nfeatures=args.max_feature_detection, nOctaveLayers=args.octave_layers,
    ...
    colors_list, boundary, feature_maps_list, start_h, start_w = \
        utils.gather_feature_matching_data(feature_descriptor_model_path=Path(args.trained_model_path),
    ...
    sift_keypoints_list, sift_keypoint_location_list_1D, sift_keypoint_location_list_2D, sift_descriptions_list = \
        utils.extract_keypoints(sift, colors_list, boundary, args.input_size[0], args.input_size[1])
